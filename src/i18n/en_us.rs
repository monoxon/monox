...
pub const TRANSLATIONS: &[(&str, &str)] = &[
    ...
    ("scheduler.execution_summary", "Task Execution Summary"),
    ("scheduler.summary_total", "Total tasks: {}"),
    ("scheduler.summary_completed", "Completed tasks: {}"),
    ("scheduler.summary_successful", "Successful tasks: {}"),
    ("scheduler.summary_failed", "Failed tasks: {}"),
    ("scheduler.summary_duration", "Total duration: {:.2}s"),
    ...
    ("scheduler.progress_update", "Progress: {}/{} completed"),
