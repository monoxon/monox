...
pub const TRANSLATIONS: &[(&str, &str)] = &[
    ...
    ("check.outdated.checking", "Checking for outdated dependencies..."),
    ...
    ("check.outdated.found_with_total", "Checked {} dependencies, found {} outdated packages"),
    ("check.outdated.found_with_total_and_instances", "Checked {} dependencies, found {} outdated packages ({} references)"),
    ("check.outdated.summary_clean", "Checked {} dependencies, all are up to date"),
    ...
    // Update related
    ("update.missing_package_or_all", "Must specify dependency name or use --all flag"),
    ("update.no_packages_found", "No package.json files found"),
    ("update.dependency_not_found", "Specified dependency not found"),
    ("update.checking_outdated", "Checking outdated dependencies..."),
    ("update.checking_dependency", "Checking dependency: {}"),
    ("update.no_outdated_found", "No outdated dependencies found"),
    ("update.version_fetch_failed", "Failed to fetch latest version for {}"),
    ("update.skipping_path", "Skipping path: {}"),
    ("update.found_package_files", "Found {} package.json files"),
    ("update.plan_details", "Update Plan Details"),
    ("update.package_header", "Package {}:"),
    ("update.update_simple", "  {} {} → {}"),
    ("update.total_updates", "Total {} update operations"),
    ("update.dry_run_complete", "Dry run complete, no actual updates executed"),
    ("update.processing_package", "Processing package: {}"),
    ("update.updated_dependency", "Updated dependency: {} {} → {}"),
    ("update.updated_package", "Updated package: {}"),
    ("update.completed", "Update completed, executed {} update operations"),
    ("update.results_details", "Update Results Details"),
    ...
    ("cli.update.start", "Starting dependency updates..."),
    // Fix related
    ...
    ("executor.task_skipped", "Task skipped: {} - {}"),
    ("executor.stage_concurrent_start", "Starting concurrent execution of stage with {} tasks"),
    ("executor.stage_concurrent_complete", "Stage concurrent execution completed: {}/{} tasks successful"),
    ("executor.task_concurrent_success", "Task completed: {}"),
    ("executor.task_concurrent_failed", "Task failed: {}, error: {}"),
    ...
    ("executor.script_not_exist", "Script not found"),
    ...
    ("scheduler.task_failed", "Task failed: {}, took {:.2}s, error: {}"),
    ("scheduler.task_timeout", "Task timed out: {}, took {:.2}s"),
    ("scheduler.task_cancelled", "Task cancelled: {}"),
    ("scheduler.fail_fast_triggered", "Task {} failed, stopping all other tasks (fail-fast mode)"),
    ("scheduler.batch_start", "Starting batch execution with {} tasks"),
    ("scheduler.batch_complete", "Batch execution completed: {}/{} tasks successful"),
    ("scheduler.task_join_error", "Failed to join task: {}"),
    ("scheduler.stopping_all_tasks", "Stopping all running tasks..."),
    ("scheduler.summary_total", "Total tasks: {}"),
    ("scheduler.dependency_check_start", "Starting dependency check for {} packages"),
    ("scheduler.dependency_check_complete", "Dependency check completed"),
    // Runner UI related
    ...
    ("runner.task_skipped", "Task {} in {} skipped"),
